...
<style>
  ...
  *{{margin:0;padding:0;box-sizing:border-box}}
  ...
  .logos{{display:flex;align-items:center;gap:18px;margin-bottom:26px}}
  .lg-factec{{height:46px;width:auto}}
  .lg-sep{{width:1px;height:38px;background:var(--line)}}
  .lg-fyllu{{display:flex;align-items:center;gap:8px}}
  .lg-fyllu img{{height:26px;width:auto}}
  .lg-fyllu span{{font-weight:800;font-size:19px;letter-spacing:-.3px;color:var(--ink)}}
  ...
  .acc{{width:100%;max-width:680px;display:flex;gap:12px;margin-bottom:22px;flex-wrap:wrap}}
  .acc-item{{flex:1;min-width:260px;display:flex;align-items:center;gap:14px;padding:14px 18px;text-decoration:none;color:var(--ink)}}
  .acc-item:hover{{border-color:var(--purple);transform:translateY(-1px);transition:.15s}}
  .acc-item .ic{{font-size:22px}}
  .acc-item b{{font-size:14px;display:block}}
  .acc-item span{{font-size:11.5px;color:var(--muted)}}
...
<body>
  ...
  <div class="acc">
    <a class="card acc-item" href="https://meet.google.com/bbp-iqaj-mhy" target="_blank">
      <div class="ic">🎦</div><div><b>Sala de clases (Google Meet)</b><span>Mismo enlace todas las sesiones · ingresa como Apellido.Nombre</span></div>
    </a>
    <a class="card acc-item" href="https://drive.google.com/drive/folders/1WMxvNrlUw88F_eTNltUMuUOWvGC7bl81" target="_blank">
      <div class="ic">📁</div><div><b>Grabaciones y material</b><span>Carpeta compartida del curso (solo participantes)</span></div>
    </a>
  </div>
